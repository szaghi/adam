...
> 1D Riemann Problem of Sod along Y axis — NASTO NVF backend.

This test solves a 1D Riemann Problem of Sod along the Y axis using ADAM NASTO compiled with the NVF backend. The test is configured to run quickly on a single NVIDIA GPU.
