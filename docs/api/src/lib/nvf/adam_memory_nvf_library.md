...
**Module procedures**: [`alloc_var_gpu_R8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-1d), [`alloc_var_gpu_R8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-2d), [`alloc_var_gpu_R8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-3d), [`alloc_var_gpu_R8P_4D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-4d), [`alloc_var_gpu_R8P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-5d), [`alloc_var_gpu_R8P_6D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-6d), [`alloc_var_gpu_I4P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i4p-1d), [`alloc_var_gpu_I4P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i4p-5d), [`alloc_var_gpu_I8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-1d), [`alloc_var_gpu_I8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-2d), [`alloc_var_gpu_I8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-3d)

### assign_allocatable_gpu

Assign GPU variable with memory checking.

**Module procedures**: [`assign_allocatable_gpu_R8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-1d), [`assign_allocatable_gpu_R8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-2d), [`assign_allocatable_gpu_R8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-3d), [`assign_allocatable_gpu_R8P_4D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-4d), [`assign_allocatable_gpu_I4P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i4p-1d), [`assign_allocatable_gpu_I4P_1D_rhs_allocated`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i4p-1d-rhs-allocated), [`assign_allocatable_gpu_I4P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i4p-5d), [`assign_allocatable_gpu_I8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i8p-2d), [`assign_allocatable_gpu_I8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i8p-3d)
