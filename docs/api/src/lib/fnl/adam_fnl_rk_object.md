---
title: adam_fnl_rk_object
---

# adam_fnl_rk_object

> ADAM, RK class FNL (FNL backend of [rk_object](/api/src/lib/common/adam_rk_object#rk-object)).
...
```mermaid
graph LR
  adam_fnl_rk_object["adam_fnl_rk_object"] --> adam_fnl_mpih_object["adam_fnl_mpih_object"]
  adam_fnl_rk_object["adam_fnl_rk_object"] --> adam_fnl_rk_kernels["adam_fnl_rk_kernels"]
  adam_fnl_rk_object["adam_fnl_rk_object"] --> adam_rk_object["adam_rk_object"]
  adam_fnl_rk_object["adam_fnl_rk_object"] --> fundal["fundal"]
  adam_fnl_rk_object["adam_fnl_rk_object"] --> penf["penf"]
```

## Contents

- [rk_fnl_object](#rk-fnl-object)
...
|------|------|--------|------------|-------------|
| `self` | class([rk_fnl_object](/api/src/lib/fnl/adam_fnl_rk_object#rk-fnl-object)) | inout |  | RK object. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([rk_fnl_object](/api/src/lib/fnl/adam_fnl_rk_object#rk-fnl-object)) | in |  | RK object. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([rk_fnl_object](/api/src/lib/fnl/adam_fnl_rk_object#rk-fnl-object)) | inout |  | RK FNL object. |
