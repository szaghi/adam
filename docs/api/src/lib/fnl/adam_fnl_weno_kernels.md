---
title: adam_fnl_weno_kernels
---

# adam_fnl_weno_kernels

> ADAM, WENO class FNL kernels (FNL backend of [weno_fnl_object](/api/src/lib/fnl/adam_fnl_weno_object#weno-fnl-object)).
...
```mermaid
graph LR
  adam_fnl_weno_kernels["adam_fnl_weno_kernels"] --> adam_weno_object["adam_weno_object"]
  adam_fnl_weno_kernels["adam_fnl_weno_kernels"] --> penf["penf"]
```

## Contents

- [weno_reconstruct_upwind_dev](#weno-reconstruct-upwind-dev)
...
flowchart TD
  ...
  style weno_reconstruct_upwind_dev fill:#3e63dd,stroke:#99b,stroke-width:2px
```
