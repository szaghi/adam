---
title: adam_fnl_ib_object
---

# adam_fnl_ib_object

> ADAM, IB class FNL (FNL backend of [ib_object](/api/src/lib/common/adam_ib_object#ib-object)).
...
```mermaid
graph LR
  adam_fnl_ib_object["adam_fnl_ib_object"] --> adam_fnl_field_object["adam_fnl_field_object"]
  adam_fnl_ib_object["adam_fnl_ib_object"] --> adam_fnl_ib_kernels["adam_fnl_ib_kernels"]
  adam_fnl_ib_object["adam_fnl_ib_object"] --> adam_fnl_mpih_object["adam_fnl_mpih_object"]
  adam_fnl_ib_object["adam_fnl_ib_object"] --> adam_ib_object["adam_ib_object"]
  adam_fnl_ib_object["adam_fnl_ib_object"] --> fundal["fundal"]
  adam_fnl_ib_object["adam_fnl_ib_object"] --> penf["penf"]
```

## Contents

- [ib_fnl_object](#ib-fnl-object)
...
| `field_gpu` | type([field_fnl_object](/api/src/lib/fnl/adam_fnl_field_object#field-fnl-object)) | pointer | Field FNL handler. |
...
|------|------|--------|------------|-------------|
| `self` | class([ib_fnl_object](/api/src/lib/fnl/adam_fnl_ib_object#ib-fnl-object)) | in |  | IB. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([ib_fnl_object](/api/src/lib/fnl/adam_fnl_ib_object#ib-fnl-object)) | inout |  | IB FNL object. |
| `ib` | type([ib_object](/api/src/lib/common/adam_ib_object#ib-object)) | in | target | IB object. |
| `field_gpu` | type([field_fnl_object](/api/src/lib/fnl/adam_fnl_field_object#field-fnl-object)) | in | target | The field. |
