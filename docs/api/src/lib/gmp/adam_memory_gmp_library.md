...
```mermaid
graph LR
  adam_memory_gmp_library["adam_memory_gmp_library"] --> adam_gmp_utils["adam_gmp_utils"]
  adam_memory_gmp_library["adam_memory_gmp_library"] --> omp_lib["omp_lib"]
  adam_memory_gmp_library["adam_memory_gmp_library"] --> penf["penf"]
```
...
- [alloc_var_gpu_I4P_2D](#alloc-var-gpu-i4p-2d)
...
**Module procedures**: [`alloc_var_gpu_R8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-1d), [`alloc_var_gpu_R8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-2d), [`alloc_var_gpu_R8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-3d), [`alloc_var_gpu_R8P_4D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-4d), [`alloc_var_gpu_R8P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-5d), [`alloc_var_gpu_R8P_6D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-r8p-6d), [`alloc_var_gpu_I4P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i4p-1d), [`alloc_var_gpu_I4P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i4p-2d), [`alloc_var_gpu_I4P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i4p-5d), [`alloc_var_gpu_I8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-1d), [`alloc_var_gpu_I8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-2d), [`alloc_var_gpu_I8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#alloc-var-gpu-i8p-3d)

### assign_allocatable_gpu

Assign GPU variable with memory checking.

**Module procedures**: [`assign_allocatable_gpu_R8P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-1d), [`assign_allocatable_gpu_R8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-2d), [`assign_allocatable_gpu_R8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-3d), [`assign_allocatable_gpu_R8P_4D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-r8p-4d), [`assign_allocatable_gpu_I4P_1D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i4p-1d), [`assign_allocatable_gpu_I4P_5D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i4p-5d), [`assign_allocatable_gpu_I8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i8p-2d), [`assign_allocatable_gpu_I8P_3D`](/api/src/lib/gmp/adam_memory_gmp_library#assign-allocatable-gpu-i8p-3d)

### transpose_a

**Module procedures**: [`transpose_a_R8P_2D`](/api/src/lib/gmp/adam_memory_gmp_library#transpose-a-r8p-2d)
...
|------|------|--------|------------|-------------|
| `var` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Varibale to be allocate on GPU. |
| `ulb` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Upper/lower bounds of variable. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | OpenMP device ID. |
| `init_val` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Initialization value. |
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_1D["alloc_var_gpu_R8P_1D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_1D["alloc_var_gpu_R8P_1D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_2D["alloc_var_gpu_R8P_2D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_2D["alloc_var_gpu_R8P_2D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_3D["alloc_var_gpu_R8P_3D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_3D["alloc_var_gpu_R8P_3D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_4D["alloc_var_gpu_R8P_4D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_4D["alloc_var_gpu_R8P_4D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_5D["alloc_var_gpu_R8P_5D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_5D["alloc_var_gpu_R8P_5D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_R8P_6D["alloc_var_gpu_R8P_6D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_R8P_6D["alloc_var_gpu_R8P_6D"] --> omp_target_free_f["omp_target_free_f"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `var` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Varibale to be allocate on GPU. |
| `ulb` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Upper/lower bounds of variable. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | OpenMP device ID. |
| `init_val` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Initialization value. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
```mermaid
flowchart TD
  alloc_var_gpu_I4P_1D["alloc_var_gpu_I4P_1D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I4P_1D["alloc_var_gpu_I4P_1D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_I4P_2D["alloc_var_gpu_I4P_2D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I4P_2D["alloc_var_gpu_I4P_2D"] --> omp_target_free_f["omp_target_free_f"]
  style alloc_var_gpu_I4P_2D fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  alloc_var_gpu_I4P_5D["alloc_var_gpu_I4P_5D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I4P_5D["alloc_var_gpu_I4P_5D"] --> omp_target_free_f["omp_target_free_f"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `var` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Varibale to be allocate on GPU. |
| `ulb` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Upper/lower bounds of variable. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | OpenMP device ID. |
| `init_val` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Initialization value. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
```mermaid
flowchart TD
  alloc_var_gpu_I8P_1D["alloc_var_gpu_I8P_1D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I8P_1D["alloc_var_gpu_I8P_1D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_I8P_2D["alloc_var_gpu_I8P_2D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I8P_2D["alloc_var_gpu_I8P_2D"] --> omp_target_free_f["omp_target_free_f"]
...
```mermaid
flowchart TD
  alloc_var_gpu_I8P_3D["alloc_var_gpu_I8P_3D"] --> omp_target_alloc_f["omp_target_alloc_f"]
  alloc_var_gpu_I8P_3D["alloc_var_gpu_I8P_3D"] --> omp_target_free_f["omp_target_free_f"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Left hand side of assignement. |
| `rhs` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | allocatable, target | Right hand side of assignement. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Flag to activate verbose mode. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
flowchart TD
  ...
  assign_allocatable_gpu_R8P_1D["assign_allocatable_gpu_R8P_1D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_R8P_1D["assign_allocatable_gpu_R8P_1D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
flowchart TD
  ...
  assign_allocatable_gpu_R8P_2D["assign_allocatable_gpu_R8P_2D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_R8P_2D["assign_allocatable_gpu_R8P_2D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
flowchart TD
  ...
  assign_allocatable_gpu_R8P_3D["assign_allocatable_gpu_R8P_3D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_R8P_3D["assign_allocatable_gpu_R8P_3D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
flowchart TD
  ...
  assign_allocatable_gpu_R8P_4D["assign_allocatable_gpu_R8P_4D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_R8P_4D["assign_allocatable_gpu_R8P_4D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Left hand side of assignement. |
| `rhs` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | allocatable, target | Right hand side of assignement. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Flag to activate verbose mode. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
flowchart TD
  ...
  assign_allocatable_gpu_I4P_1D["assign_allocatable_gpu_I4P_1D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_I4P_1D["assign_allocatable_gpu_I4P_1D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
|------|------|--------|------------|-------------|
| `lhs` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Left hand side of assignement. |
| `rhsa` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | target | Right hand side of assignement. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Flag to activate verbose mode. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
flowchart TD
  ...
  assign_allocatable_gpu_I4P_1D_rhs_allocated["assign_allocatable_gpu_I4P_1D_rhs_allocated"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_I4P_1D_rhs_allocated["assign_allocatable_gpu_I4P_1D_rhs_allocated"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
flowchart TD
  ...
  assign_allocatable_gpu_I4P_5D["assign_allocatable_gpu_I4P_5D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_I4P_5D["assign_allocatable_gpu_I4P_5D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | pointer | Left hand side of assignement. |
| `rhs` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | allocatable, target | Right hand side of assignement. |
| `omp_dev` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Flag to activate verbose mode. |
| `msg` | character(len=*) | in | optional | Message to be printed in verbose mode. |
| `verbose` | logical | in | optional | Flag to activate verbose mode. |
...
flowchart TD
  ...
  assign_allocatable_gpu_I8P_2D["assign_allocatable_gpu_I8P_2D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_I8P_2D["assign_allocatable_gpu_I8P_2D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
...
flowchart TD
  ...
  assign_allocatable_gpu_I8P_3D["assign_allocatable_gpu_I8P_3D"] --> omp_target_free_f["omp_target_free_f"]
  assign_allocatable_gpu_I8P_3D["assign_allocatable_gpu_I8P_3D"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
