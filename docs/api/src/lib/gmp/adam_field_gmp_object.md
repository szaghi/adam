...
```mermaid
graph LR
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_common_library["adam_common_library"]
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_field_gmp_kernels["adam_field_gmp_kernels"]
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_gmp_utils["adam_gmp_utils"]
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_maps_gmp_object["adam_maps_gmp_object"]
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_memory_gmp_library["adam_memory_gmp_library"]
  adam_field_gmp_object["adam_field_gmp_object"] --> adam_mpih_gmp_object["adam_mpih_gmp_object"]
  adam_field_gmp_object["adam_field_gmp_object"] --> mpi["mpi"]
  adam_field_gmp_object["adam_field_gmp_object"] --> penf["penf"]
```

## Contents

- [field_gmp_object](#field-gmp-object)
...
| `maps` | type([maps_gmp_object](/api/src/lib/gmp/adam_maps_gmp_object#maps-gmp-object)) |  | Maps handler. |
...
| `x_cell_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | pointer | Cells x coordinates on GPU. |
| `y_cell_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | pointer | Cells y coordinates on GPU. |
| `z_cell_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | pointer | Cells z coordinates on GPU. |
| `dxyz_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | pointer | Delta cells GPU. |
...
| `copy_cpu_gpu` | pass(self) | Copy data from (field_object) CPU to (field_gmp_object) GPU. |
...
|------|------|--------|------------|-------------|
| `self` | class([field_gmp_object](/api/src/lib/gmp/adam_field_gmp_object#field-gmp-object)) | in |  | The field. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([field_gmp_object](/api/src/lib/gmp/adam_field_gmp_object#field-gmp-object)) | inout |  | The field. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([field_gmp_object](/api/src/lib/gmp/adam_field_gmp_object#field-gmp-object)) | inout |  | The equation. |
...
flowchart TD
  ...
  copy_cpu_gpu["copy_cpu_gpu"] --> copy_transpose_cpu_gpu["copy_transpose_cpu_gpu"]
  copy_cpu_gpu["copy_cpu_gpu"] --> copy_transpose_cpu_gpu["copy_transpose_cpu_gpu"]
  copy_transpose_cpu_gpu["copy_transpose_cpu_gpu"] --> omp_target_memcpy_f["omp_target_memcpy_f"]
