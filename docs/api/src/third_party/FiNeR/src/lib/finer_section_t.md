...
**Source**: `src/third_party/FiNeR/src/lib/finer_section_t.f90`
...
graph LR
  ...
  finer_section_t["finer_section_t"] --> penf["penf"]
  finer_section_t["finer_section_t"] --> stringifor["stringifor"]
```
...
| `options` | type([option](/api/src/third_party/FiNeR/src/lib/finer_option_t#option)) | allocatable | Section options. |
...
**Module procedures**: [`new_section`](/api/src/third_party/FiNeR/src/lib/finer_section_t#new-section)
...
|------|------|--------|------------|-------------|
| `self` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | inout |  | Section data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | in |  | Option data. |
...
| `source` | type([string](/api/src/third_party/StringiFor/src/lib/stringifor_string_t#string)) | inout |  | String containing section data. |
| `error` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out |  | Error code. |
| `token_failed` | type([string](/api/src/third_party/StringiFor/src/lib/stringifor_string_t#string)) | out | optional | Eventual token failed to parse. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | in |  | Section data. |
...
|------|------|--------|------------|-------------|
| `self` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | inout |  | Section data. |
| `source` | type([string](/api/src/third_party/StringiFor/src/lib/stringifor_string_t#string)) | in |  | String containing section data. |
| `error` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out |  | Error code. |
...
flowchart TD
  parse["parse"] --> parse_options["parse_options"]
  parse_options["parse_options"] --> parse["parse"]
  parse_options["parse_options"] --> slice["slice"]
  parse_options["parse_options"] --> split["split"]
...
flowchart TD
  parse["parse"] --> sanitize_source["sanitize_source"]
  sanitize_source["sanitize_source"] --> slice["slice"]
  sanitize_source["sanitize_source"] --> split["split"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | inout |  | Left hand side. |
| `rhs` | type([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | in |  | Rigth hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | in |  | Left hand side. |
...
**Returns**: type([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section))
