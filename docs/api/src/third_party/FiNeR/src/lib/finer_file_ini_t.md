...
**Source**: `src/third_party/FiNeR/src/lib/finer_file_ini_t.F90`
...
graph LR
  ...
  finer_file_ini_t["finer_file_ini_t"] --> penf["penf"]
  finer_file_ini_t["finer_file_ini_t"] --> stringifor["stringifor"]
```
...
| `Ns` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Number of sections. |
| `opt_sep` | character(len=1) |  | Separator character of option name/value. |
| `sections` | type([section](/api/src/third_party/FiNeR/src/lib/finer_section_t#section)) | allocatable | Sections. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | inout |  | File data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | in |  | File data. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | inout |  | File data. |
| `source` | type([string](/api/src/third_party/StringiFor/src/lib/stringifor_string_t#string)) | in |  | String source. |
| `error` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | Error code. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | inout |  | Left hand side. |
| `rhs` | type([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | in |  | Rigth hand side. |
...
flowchart TD
  ...
  file_ini_autotest["file_ini_autotest"] --> str["str"]
...
|------|------|--------|------------|-------------|
| `self` | class([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) | in |  | File data. |
| `section_index` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Section index. |
