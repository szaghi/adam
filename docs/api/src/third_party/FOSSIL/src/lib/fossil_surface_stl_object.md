...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_surface_stl.f90`
...
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | allocatable | Facets. |
| `facet_1_de` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | Facets with one disconnected edges. |
| `facet_2_de` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | Facets with two disconnected edges. |
| `facet_3_de` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | Facets with three disconnected edges. |
| `aabb` | type([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) |  | AABB tree. |
...
|------|------|--------|------------|-------------|
| `self` | class([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | inout |  | File STL. |
...
| `remainder` | type([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | out | optional | Remainder part of the triangulated surface. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | in |  | File STL. |
...
|------|------|--------|------------|-------------|
| `self` | class([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | inout |  | File STL. |
| `other` | type([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | in |  | Other file STL. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | inout |  | Left hand side. |
| `rhs` | type([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | in |  | Right hand side. |
