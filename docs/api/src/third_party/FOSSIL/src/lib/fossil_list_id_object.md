...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_list_id_object.f90`
...
|------|------|--------|------------|-------------|
| `self` | class([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) | inout |  | List. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) | inout |  | Left hand side. |
| `rhs` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) | in |  | Right hand side. |
