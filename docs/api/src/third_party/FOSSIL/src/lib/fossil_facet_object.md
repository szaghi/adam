...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_facet_object.f90`
...
| `vertex_occurrence` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | List of vertices "occurrencies", list of facets global ID containing them. |
| `vertex_nearby` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | List of vertices "nearby", list of vertices global ID nearby them. |
...
|------|------|--------|------------|-------------|
| `self` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Facet. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in |  | Facet. |
| `file_unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | File unit. |
...
|------|------|--------|------------|-------------|
| `self` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Facet. |
| `other` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Other facet. |
...
|------|------|--------|------------|-------------|
| `self` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Facet. |
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | All facets in STL. |
...
| `other` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Other facet to make consistent with self. |
...
|------|------|--------|------------|-------------|
| `self` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in |  | Facet. |
| `other` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in |  | Other facet. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | Left hand side. |
| `rhs` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in |  | Right hand side. |
...
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | inout |  | All facets in STL. |
| `nearby` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) | inout |  | List of nearby vertices global ID. |
