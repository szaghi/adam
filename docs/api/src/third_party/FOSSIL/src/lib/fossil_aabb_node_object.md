...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_aabb_node_object.f90`
...
|------|------|--------|------------|-------------|
| `self` | class([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | inout |  | AABB. |
...
|------|------|--------|------------|-------------|
| `self` | class([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | inout |  | AABB. |
| `node` | type([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | in |  | Nodes list. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | inout |  | Left hand side. |
| `rhs` | type([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | in |  | AABB box. |
...
**Returns**: type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object))
