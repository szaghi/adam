...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_block_object.f90`
...
|------|------|--------|------------|-------------|
| `self` | class([block_object](/api/src/third_party/FOSSIL/src/lib/fossil_block_object#block-object)) | inout |  | Block. |
...
|------|------|--------|------------|-------------|
| `self` | class([block_object](/api/src/third_party/FOSSIL/src/lib/fossil_block_object#block-object)) | inout |  | Block. |
| `surface_stl` | type([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | in |  | STL surface. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([block_object](/api/src/third_party/FOSSIL/src/lib/fossil_block_object#block-object)) | in |  | Block. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([block_object](/api/src/third_party/FOSSIL/src/lib/fossil_block_object#block-object)) | inout |  | Left hand side. |
| `rhs` | type([block_object](/api/src/third_party/FOSSIL/src/lib/fossil_block_object#block-object)) | in |  | Right hand side. |
