...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_file_stl_object.f90`
...
|------|------|--------|------------|-------------|
| `self` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | inout |  | File STL. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | inout |  | File STL. |
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | out | allocatable | Surface facets. |
| `file_name` | character(len=*) | in | optional | File name. |
| `is_ascii` | logical | in | optional | Sentinel to check if file is ASCII. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | inout |  | File STL. |
| `surface` | type([surface_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_surface_stl_object#surface-stl-object)) | in |  | Surface STL. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | inout |  | File STL. |
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in |  | Surface facets. |
| `file_name` | character(len=*) | in | optional | File name. |
| `is_ascii` | logical | in | optional | Sentinel to check if file is ASCII. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | inout |  | Left hand side. |
| `rhs` | type([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([file_stl_object](/api/src/third_party/FOSSIL/src/lib/fossil_file_stl_object#file-stl-object)) | in |  | File STL. |
