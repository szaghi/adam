...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_aabb_object.f90`
...
| `facet_id` | type([list_id_object](/api/src/third_party/FOSSIL/src/lib/fossil_list_id_object#list-id-object)) |  | List of facets IDs contained into AABB. |
