...
**Source**: `src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object.f90`
...
| `octree_fsm` | type([ofsm](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#ofsm)) |  |  |
...
| `node` | type([aabb_node_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_node_object#aabb-node-object)) | allocatable | AABB tree nodes [0:nodes_number-1]. |
...
|------|------|--------|------------|-------------|
| `self` | class([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | in |  | AABB tree. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | inout |  | AABB tree. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | inout |  | AABB. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | inout |  | Left hand side. |
| `rhs` | type([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | in |  | Right hand side. |
...
|------|------|--------|------------|-------------|
| `self` | class([aabb_tree_object](/api/src/third_party/FOSSIL/src/lib/fossil_aabb_tree_object#aabb-tree-object)) | in |  | AABB tree. |
| `facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | in | optional | Whole facets list. |
| `aabb_facet` | type([facet_object](/api/src/third_party/FOSSIL/src/lib/fossil_facet_object#facet-object)) | out | allocatable, optional | AABB facets list. |
