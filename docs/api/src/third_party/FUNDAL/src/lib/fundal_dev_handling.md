...
**Source**: `src/third_party/FUNDAL/src/lib/fundal_dev_handling.F90`
...
|------|------|--------|------------|-------------|
| `mem_free` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | Free memory. |
| `mem_total` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | Total memory. |
...
| `memory` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | Device memory. |
