---
title: adam_chase_riemann_library
---

# adam_chase_riemann_library

> ADAM, CHASE Riemann Problem solvers and convective fluxes computations library, common CPU backend.

**Source**: `src/app/chase/common/adam_chase_riemann_library.F90`

**Dependencies**

```mermaid
graph LR
  adam_chase_riemann_library["adam_chase_riemann_library"] --> adam_chase_parameters["adam_chase_parameters"]
  adam_chase_riemann_library["adam_chase_riemann_library"] --> adam_chase_physics_object["adam_chase_physics_object"]
  adam_chase_riemann_library["adam_chase_riemann_library"] --> penf["penf"]
```
