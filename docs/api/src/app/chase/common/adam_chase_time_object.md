---
title: adam_chase_time_object
---

# adam_chase_time_object

> ADAM, CHASE time handler class definition, common CPU backend.

**Source**: `src/app/chase/common/adam_chase_time_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_chase_time_object["adam_chase_time_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_chase_time_object["adam_chase_time_object"] --> finer["finer"]
  adam_chase_time_object["adam_chase_time_object"] --> penf["penf"]
```

## Contents

- [chase_time_object](#chase-time-object)
...
chase time handler class definition, CPU backend.
...
|------|------|--------|------------|-------------|
| `self` | class([chase_time_object](/api/src/app/chase/common/adam_chase_time_object#chase-time-object)) | inout |  | Time handler. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([chase_time_object](/api/src/app/chase/common/adam_chase_time_object#chase-time-object)) | in |  | Time handler. |
