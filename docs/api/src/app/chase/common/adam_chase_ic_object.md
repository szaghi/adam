...
```mermaid
graph LR
  adam_chase_ic_object["adam_chase_ic_object"] --> adam_chase_physics_object["adam_chase_physics_object"]
  adam_chase_ic_object["adam_chase_ic_object"] --> adam_field_object["adam_field_object"]
  adam_chase_ic_object["adam_chase_ic_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_chase_ic_object["adam_chase_ic_object"] --> finer["finer"]
  adam_chase_ic_object["adam_chase_ic_object"] --> penf["penf"]
```

## Contents

- [chase_ic_object](#chase-ic-object)
...
|------|------|--------|------------|-------------|
| `self` | class([chase_ic_object](/api/src/app/chase/common/adam_chase_ic_object#chase-ic-object)) | inout |  | IC. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([chase_ic_object](/api/src/app/chase/common/adam_chase_ic_object#chase-ic-object)) | in |  | IC. |
| `physics` | type([chase_physics_object](/api/src/app/chase/common/adam_chase_physics_object#chase-physics-object)) | in |  | Fluids physiscs. |
