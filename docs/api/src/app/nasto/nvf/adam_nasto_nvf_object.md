...
```mermaid
graph LR
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> adam_common_library["adam_common_library"]
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> adam_nasto_common_library["adam_nasto_common_library"]
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> adam_nasto_nvf_kernels["adam_nasto_nvf_kernels"]
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> adam_nvf_library["adam_nvf_library"]
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> mpi["mpi"]
  adam_nasto_nvf_object["adam_nasto_nvf_object"] --> penf["penf"]
```

## Contents

- [nasto_nvf_object](#nasto-nvf-object)
...
| `mpih_gpu` | type([mpih_nvf_object](/api/src/lib/nvf/adam_mpih_nvf_object#mpih-nvf-object)) |  | MPI handler, NVF backend. |
| `field_gpu` | type([field_nvf_object](/api/src/lib/nvf/adam_field_nvf_object#field-nvf-object)) |  | The field, NVF backend. |
| `ib_gpu` | type([ib_nvf_object](/api/src/lib/nvf/adam_ib_nvf_object#ib-nvf-object)) |  | IB handler, NVF backend. |
| `rk_gpu` | type([rk_nvf_object](/api/src/lib/nvf/adam_rk_nvf_object#rk-nvf-object)) |  | RK integrator, NVF backend. |
| `weno_gpu` | type([weno_nvf_object](/api/src/lib/nvf/adam_weno_nvf_object#weno-nvf-object)) |  | WENO reconstructor, NVF backend. |
| `q_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | pointer, device | Field cell centered variables. |
| `q_aux_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Auxiliary cell centered variables. |
| `dq_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Eikonal right hand side. |
| `flx_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Fluxes along x. |
| `fly_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Fluxes along y. |
| `flz_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Fluxes along z. |
| `q_bc_vars_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable, device | Variables array for boundary conditions on GPU. |
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_nvf_object](/api/src/app/nasto/nvf/adam_nasto_nvf_object#nasto-nvf-object)) | inout |  | The equation. |
| `q_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | device, target | Conservative variables. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_nvf_object](/api/src/app/nasto/nvf/adam_nasto_nvf_object#nasto-nvf-object)) | in |  | The equation. |
| `q_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | device | Conservative variables. |
...
| `q_aux_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | device | Auxiliary variables. |
...
flowchart TD
  ...
  compute_q_auxiliary["compute_q_auxiliary"] --> compute_q_aux_cuf["compute_q_aux_cuf"]
...
| `self` | class([nasto_nvf_object](/api/src/app/nasto/nvf/adam_nasto_nvf_object#nasto-nvf-object)) | inout |  | The equation. |
| `q_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | device | Conservative variables. |
| `dq_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout | device | Residuals. |
