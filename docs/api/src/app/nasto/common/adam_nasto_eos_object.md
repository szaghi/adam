...
```mermaid
graph LR
  adam_nasto_eos_object["adam_nasto_eos_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_nasto_eos_object["adam_nasto_eos_object"] --> finer["finer"]
  adam_nasto_eos_object["adam_nasto_eos_object"] --> penf["penf"]
```

## Contents

- [nasto_eos_object](#nasto-eos-object)
- [nasto_eos_object](#nasto-eos-object)
...
- [nasto_physics_assign_nasto_physics](#nasto-physics-assign-nasto-physics)
...
- [nasto_eos_instance](#nasto-eos-instance)
...
Overload [nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object) name with its constructor.

**Module procedures**: [`nasto_eos_instance`](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-instance)
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | inout |  | Fluid physics. |
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | inout |  | Fluid physics. |
| `physics` | type([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | in | optional | Fluid physics. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | inout |  | Free conditions. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | inout |  | Left hand side. |
| `rhs` | type([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object)) | in |  | Fluid physics. |
...
Return and instance of [nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object).

 @note This procedure is used for overloading [nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object) name.

**Attributes**: elemental

**Returns**: type([nasto_eos_object](/api/src/app/nasto/common/adam_nasto_eos_object#nasto-eos-object))
...
flowchart TD
  nasto_eos_instance["nasto_eos_instance"] --> compute_derivate["compute_derivate"]
  style nasto_eos_instance fill:#3e63dd,stroke:#99b,stroke-width:2px
```
