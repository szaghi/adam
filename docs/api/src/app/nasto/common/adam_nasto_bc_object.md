...
```mermaid
graph LR
  adam_nasto_bc_object["adam_nasto_bc_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_nasto_bc_object["adam_nasto_bc_object"] --> finer["finer"]
  adam_nasto_bc_object["adam_nasto_bc_object"] --> penf["penf"]
```

## Contents

- [nasto_bc_object](#nasto-bc-object)
...
| `q` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable | Primitive variables (r,u,v,w,p,s with s being the specie index) at BC. |
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_bc_object](/api/src/app/nasto/common/adam_nasto_bc_object#nasto-bc-object)) | inout |  | BC. |
