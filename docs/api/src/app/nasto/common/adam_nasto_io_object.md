---
title: adam_nasto_io_object
---

# adam_nasto_io_object

> ADAM, Navier-Stokes IO handler class definition, CPU backend.

**Source**: `src/app/nasto/common/adam_nasto_io_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_nasto_io_object["adam_nasto_io_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_nasto_io_object["adam_nasto_io_object"] --> finer["finer"]
  adam_nasto_io_object["adam_nasto_io_object"] --> penf["penf"]
```

## Contents

- [nasto_io_object](#nasto-io-object)
...
| `file_parameters` | type([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) |  | Nasto input file handler. |
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_io_object](/api/src/app/nasto/common/adam_nasto_io_object#nasto-io-object)) | inout |  | IO handler. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_io_object](/api/src/app/nasto/common/adam_nasto_io_object#nasto-io-object)) | in |  | IO handler. |
