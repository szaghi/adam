---
title: adam_nasto_time_object
---

# adam_nasto_time_object

> ADAM, Navier-Stokes time handler class definition, CPU backend.

**Source**: `src/app/nasto/common/adam_nasto_time_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_nasto_time_object["adam_nasto_time_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_nasto_time_object["adam_nasto_time_object"] --> finer["finer"]
  adam_nasto_time_object["adam_nasto_time_object"] --> penf["penf"]
```

## Contents

- [nasto_time_object](#nasto-time-object)
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_time_object](/api/src/app/nasto/common/adam_nasto_time_object#nasto-time-object)) | inout |  | Time handler. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_time_object](/api/src/app/nasto/common/adam_nasto_time_object#nasto-time-object)) | in |  | Time handler. |
