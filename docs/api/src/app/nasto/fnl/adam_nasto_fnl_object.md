---
title: adam_nasto_fnl_object
---

# adam_nasto_fnl_object

> ADAM, Navier-Stokes equations system class definition, GPU (FNL) backend.

**Source**: `src/app/nasto/fnl/adam_nasto_fnl_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_nasto_fnl_object["adam_nasto_fnl_object"] --> adam_nasto_fnl_library["adam_nasto_fnl_library"]
  adam_nasto_fnl_object["adam_nasto_fnl_object"] --> fundal["fundal"]
  adam_nasto_fnl_object["adam_nasto_fnl_object"] --> mpi["mpi"]
  adam_nasto_fnl_object["adam_nasto_fnl_object"] --> penf["penf"]
```

## Contents

- [nasto_fnl_object](#nasto-fnl-object)
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_fnl_object](/api/src/app/nasto/fnl/adam_nasto_fnl_object#nasto-fnl-object)) | inout |  | The equation. |
...
flowchart TD
  ...
  allocate_gpu["allocate_gpu"] --> dev_assign_to_device["dev_assign_to_device"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_fnl_object](/api/src/app/nasto/fnl/adam_nasto_fnl_object#nasto-fnl-object)) | in |  | The equation. |
| `q_gpu` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Conservative variables. |
