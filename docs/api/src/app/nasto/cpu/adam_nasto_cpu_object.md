...
```mermaid
graph LR
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> adam_common_library["adam_common_library"]
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> adam_nasto_common_library["adam_nasto_common_library"]
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> adam_nasto_cpu_cns["adam_nasto_cpu_cns"]
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> adam_riemann_euler_library["adam_riemann_euler_library"]
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> mpi["mpi"]
  adam_nasto_cpu_object["adam_nasto_cpu_object"] --> penf["penf"]
```

## Contents

- [nasto_cpu_object](#nasto-cpu-object)
...
- [compute_fluxes_diffusive](#compute-fluxes-diffusive)
- [compute_q_gradient](#compute-q-gradient)
- [decompose_fluxes_convective](#decompose-fluxes-convective)
- [decompose_fluxes_convective_llf](#decompose-fluxes-convective-llf)
...
| `dq` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable | Eikonal right hand side. |
...
|------|------|--------|------------|-------------|
| `self` | class([nasto_cpu_object](/api/src/app/nasto/cpu/adam_nasto_cpu_object#nasto-cpu-object)) | inout |  | The equation. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([nasto_cpu_object](/api/src/app/nasto/cpu/adam_nasto_cpu_object#nasto-cpu-object)) | in |  | The equation. |
| `q` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Conservative variables. |
...
flowchart TD
  ...
  compute_residuals["compute_residuals"] --> compute_fluxes_diffusive["compute_fluxes_diffusive"]
  compute_residuals["compute_residuals"] --> compute_q_auxiliary["compute_q_auxiliary"]
  compute_residuals["compute_residuals"] --> integrate_eikonal["integrate_eikonal"]
  compute_residuals["compute_residuals"] --> update_ghost["update_ghost"]
...
flowchart TD
  ...
  compute_fluxes_convective["compute_fluxes_convective"] --> decompose_fluxes_convective_llf["decompose_fluxes_convective_llf"]
...
| `q_aux` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Auxiliary varibales |
| `dx` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Space steps. |
| `dy` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Space steps. |
| `dz` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Space steps. |
| `flx` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Fluxes along x. |
| `fly` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Fluxes along y. |
| `flz` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Fluxes along z. |
...
flowchart TD
  compute_residuals["compute_residuals"] --> compute_fluxes_diffusive["compute_fluxes_diffusive"]
  style compute_fluxes_diffusive fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
subroutine decompose_fluxes_convective_llf(sir, nv, q_aux, evmax, fmp)
```
...
| `nv` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Number of conservative varibales. |
| `q_aux` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Auxiliary variables. |
| `evmax` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Maximum waves speeds estimation. |
| `fmp` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Fluxes, negative/positive terms [1:2,1:nv]. |
...
flowchart TD
  ...
  style decompose_fluxes_convective_llf fill:#3e63dd,stroke:#99b,stroke-width:2px
```
