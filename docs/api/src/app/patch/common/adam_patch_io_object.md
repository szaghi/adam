---
title: adam_patch_io_object
---

# adam_patch_io_object

> ADAM, Maxwell IO handler class definition, common CPU backend.

**Source**: `src/app/patch/common/adam_patch_io_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_patch_io_object["adam_patch_io_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_patch_io_object["adam_patch_io_object"] --> finer["finer"]
  adam_patch_io_object["adam_patch_io_object"] --> penf["penf"]
```

## Contents

- [patch_io_object](#patch-io-object)
...
PATCH IO handler class definition, CPU backend.
...
| `file_parameters` | type([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) |  | Input file handler. |
...
|------|------|--------|------------|-------------|
| `self` | class([patch_io_object](/api/src/app/patch/common/adam_patch_io_object#patch-io-object)) | inout |  | IO handler. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([patch_io_object](/api/src/app/patch/common/adam_patch_io_object#patch-io-object)) | in |  | IO handler. |
