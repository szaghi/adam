...
```mermaid
graph LR
  adam_patch_bc_object["adam_patch_bc_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_patch_bc_object["adam_patch_bc_object"] --> finer["finer"]
  adam_patch_bc_object["adam_patch_bc_object"] --> penf["penf"]
```
