...
```mermaid
graph LR
  adam_patch_ic_object["adam_patch_ic_object"] --> adam_field_object["adam_field_object"]
  adam_patch_ic_object["adam_patch_ic_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_patch_ic_object["adam_patch_ic_object"] --> finer["finer"]
  adam_patch_ic_object["adam_patch_ic_object"] --> penf["penf"]
```

## Contents

- [patch_ic_object](#patch-ic-object)
...
| `r` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | allocatable | Rho value. |
...
|------|------|--------|------------|-------------|
| `self` | class([patch_ic_object](/api/src/app/patch/common/adam_patch_ic_object#patch-ic-object)) | inout |  | IC. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([patch_ic_object](/api/src/app/patch/common/adam_patch_ic_object#patch-ic-object)) | in |  | IC. |
| `field` | type([field_object](/api/src/lib/common/adam_field_object#field-object)) | in |  | Field object. |
| `r` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | inout |  | Conservative variables. |
