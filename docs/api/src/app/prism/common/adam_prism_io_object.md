---
title: adam_prism_io_object
---

# adam_prism_io_object

> ADAM, Maxwell IO handler class definition, CPU backend.

**Source**: `src/app/prism/common/adam_prism_io_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_prism_io_object["adam_prism_io_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_prism_io_object["adam_prism_io_object"] --> finer["finer"]
  adam_prism_io_object["adam_prism_io_object"] --> penf["penf"]
```

## Contents

- [prism_io_object](#prism-io-object)
...
| `file_parameters` | type([file_ini](/api/src/third_party/FiNeR/src/lib/finer_file_ini_t#file-ini)) |  | Prism input file handler. |
...
| `energy_error_save` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Energy error output iteration save frequency. |
| `energy_error_unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Energy error hystory file unit. |
...
|------|------|--------|------------|-------------|
| `self` | class([prism_io_object](/api/src/app/prism/common/adam_prism_io_object#prism-io-object)) | inout |  | IO handler. |
...
| `energy_D` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Energy history of D. |
| `energy_B` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Energy history of B. |
| `rms_energy_error_D` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | RMS of energy history of D. |
| `rms_energy_error_B` | real(kind=[R8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | RMS of energy history of B. |
...
flowchart TD
  ...
  save_energy_error["save_energy_error"] --> str["str"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([prism_io_object](/api/src/app/prism/common/adam_prism_io_object#prism-io-object)) | in |  | IO handler. |
