---
title: adam_prism_time_object
---

# adam_prism_time_object

> ADAM, PRISM time handler class definition, CPU backend.

**Source**: `src/app/prism/common/adam_prism_time_object.F90`

**Dependencies**

```mermaid
graph LR
  adam_prism_time_object["adam_prism_time_object"] --> adam_mpih_object["adam_mpih_object"]
  adam_prism_time_object["adam_prism_time_object"] --> finer["finer"]
  adam_prism_time_object["adam_prism_time_object"] --> penf["penf"]
```

## Contents

- [prism_time_object](#prism-time-object)
...
|------|------|--------|------------|-------------|
| `self` | class([prism_time_object](/api/src/app/prism/common/adam_prism_time_object#prism-time-object)) | inout |  | Time handler. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([prism_time_object](/api/src/app/prism/common/adam_prism_time_object#prism-time-object)) | in |  | Time handler. |
