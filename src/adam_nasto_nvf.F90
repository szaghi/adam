...
program adam_nasto_nvf
!< ADAM, Navier-Stokes application solver, GPU (NVF) backend.

use adam_nasto_nvf_object, only : nasto_nvf_object

implicit none

type(nasto_nvf_object) :: nasto           !< Navier-Stokes equations system class.
