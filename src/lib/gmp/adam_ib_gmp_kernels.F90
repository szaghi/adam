...
implicit none
private
public :: compute_eikonal_dq_phi_gmp
public :: compute_phi_all_solids_gmp
public :: compute_phi_analytical_sphere_gmp
public :: evolve_eikonal_q_phi_gmp
public :: invert_eikonal_q_phi_gmp
public :: move_phi_gmp
public :: reduce_cell_order_phi_gmp
...
contains
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(dx_gpu,dy_gpu,dz_gpu,phi_gpu,q_gpu,dq_gpu)
   do k=1, nk
      do j=1, nj
         do i=1, ni
      ...
      enddo
   enddo
   endsubroutine compute_eikonal_dq_phi_gmp
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(phi_gpu)
   do k=1, nk
      do j=1, nj
         do i=1, ni
            do b=1, blocks_number
      ...
      enddo
   enddo
   endsubroutine compute_phi_all_solids_gmp
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(x_cell_gpu,y_cell_gpu,z_cell_gpu,phi_gpu)
   do k=1, nk
      do j=1, nj
         do i=1, ni
            do b=1, blocks_number
      ...
      enddo
   enddo
   endsubroutine compute_phi_analytical_sphere_gmp
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(phi_gpu,dq_gpu,q_gpu)
   do k=1, nk
      do j=1, nj
         do i=1,ni
            do b=1, blocks_number
      ...
      enddo
   enddo
   endsubroutine evolve_eikonal_q_phi_gmp
   ...
   if     (bcs_type == BCS_VISCOUS) then
      !$omp target teams distribute parallel do collapse(4) has_device_addr(phi_gpu,q_gpu)
      do k=1-ngc, nk+ngc
         do j=1-ngc, nj+ngc
            do i=1-ngc, ni+ngc
               do b=1, blocks_number
   ...
   endsubroutine invert_eikonal_q_phi_gmp
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(phi_gpu,dphi_gpu)
   do k=1, nk
   do j=1, nj
   do i=1, ni
   do b=1, blocks_number
   ...
   enddo
   enddo
   endsubroutine move_phi_gmp

   subroutine reduce_cell_order_phi_gmp(ib, ni, nj, nk, ngc, blocks_number, iweno, &
   ...
   !$omp target teams distribute parallel do collapse(4) has_device_addr(phi_gpu,cell_scheme_gpu)
   do b=1, blocks_number
      do j=1, nj
         do k=1, nk
            idir: do i=0, ni
   ...
   do b=1, blocks_number
      ...
      enddo
   enddo
   endsubroutine reduce_cell_order_phi_gmp
endmodule adam_ib_gmp_kernels
