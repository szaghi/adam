...
contains
   ...
   call compute_q_gradient_gmp(b=b, ni=grid%ni, nj=grid%nj, nk=grid%nk, ngc=grid%ngc, &
   ...
   call update_ghost_local_gmp(local_map_ghost_cell_gpu=self%maps%local_map_ghost_cell_gpu,ngc=grid%ngc,q_gpu=q_gpu)
