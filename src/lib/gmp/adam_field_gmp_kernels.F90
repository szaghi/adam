...
public :: copy_transpose_gpu_cpu_gmp
public :: populate_send_buffer_ghost_gmp
public :: receive_recv_buffer_ghost_gmp
public :: update_ghost_local_gmp
...
contains
   ...
   do b=1, blocks_number
      do k=1-ngc, nk+ngc
         do j=1-ngc, nj+ngc
            do i=1-ngc, ni+ngc
               do v=1, nv
                  q_cpu(v,i,j,k,b) = q_t_gpu(v,i,j,k,b)
               enddo
            enddo
         enddo
      enddo
   ...
   endsubroutine populate_send_buffer_ghost_gmp
   ...
   endsubroutine receive_recv_buffer_ghost_gmp
   ...
   do v=1, size(q_gpu, dim=5)
      ...
      enddo
   enddo
   endsubroutine update_ghost_local_gmp
