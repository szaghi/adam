...
contains
   ...
   !$acc routine(weno_compute_convolution_device)
   !$omp declare target(weno_compute_convolution_device)
   ...
   !$acc routine(weno_compute_polynomials_device)
   !$omp declare target(weno_compute_polynomials_device)
   ...
   !$acc routine(weno_compute_weights_device)
   !$omp declare target(weno_compute_weights_device)
