...
module adam_mhd_schemes_object
!< ADAM, Navier-Stokes schemes handler class definition, CPU backend.
...
type :: mhd_schemes_object
   !< MHD schemes handler class definition.
...
endtype mhd_schemes_object

contains
   ! public methods
   subroutine allocate_cellc_arrays(self, nb, ngc, ni, nj, nk)
   !< Allocate cell-centered arrays.
   class(mhd_schemes_object), intent(inout) :: self !< Schemes handler.
   ...
   class(mhd_schemes_object), intent(in) :: self             !< Schemes handler.
   ...
   print '(A)', self%mpih%myrankstr//'mhd_schemes_object%initialize start'
   ...
   print '(A)', self%mpih%myrankstr//'mhd_schemes_object%initialize finish'
...
endmodule adam_mhd_schemes_object
