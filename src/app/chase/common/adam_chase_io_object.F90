...
endtype chase_io_object

contains
   ! public methods
   pure function description(self) result(desc)
   !< Return a pretty-formatted object description.
   class(chase_io_object), intent(in) :: self             !< IO handler.
   ...
   class(chase_io_object), intent(inout) :: self     !< IO handler.
   character(*),           intent(in)    :: filename !< File name of parameters file.

   call self%mpih%initialize(do_mpi_init=.false.)
   print '(A)', self%mpih%myrankstr//'chase_io_object%initialize start'
   ...
   print '(A)', self%mpih%myrankstr//'chase_io_object%initialize finish'
...
endmodule adam_chase_io_object
