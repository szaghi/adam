...
contains
   ...
   call dev_assign_from_device(src=self%d_gpu        ,dst=self%coil%d                          )
   call dev_assign_from_device(src=self%j_vec_gpu    ,dst=self%coil%j_vec    ,transposed=.true.)
   ! call dev_assign_from_device(src=self%coil_flag_gpu,dst=self%coil%coil_flag,transposed=.true.)
