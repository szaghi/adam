...
module adam_prism_common_object
    ...
    !   integer(I4P), pointer :: ns=>null()            !< Number of fluids specie.
     ...
     !  integer(I4P), pointer :: nv_aux=>null()        !< Number of auxiliary variables.
       ! auxiliary fields data: see prism parameters definition for the arrangement of conservative and auxiliary variables
    ...
    contains
       ...
       call self%physics%initialize(ni=self%ni, nj=self%nj, nk=self%nk, nb=self%nb)
