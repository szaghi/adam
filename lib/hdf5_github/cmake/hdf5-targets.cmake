...
foreach(_cmake_expected_target IN ITEMS hdf5-static mirror_server mirror_server_stop hdf5_tools-static h5diff ph5diff h5ls h5debug h5repart h5mkgrp h5clear h5delete h5import h5repack h5jam h5unjam h5copy h5stat h5dump h5format_convert h5perf_serial h5perf hdf5_hl-static h5watch hdf5_f90cstub-static hdf5_fortran-static hdf5_hl_f90cstub-static hdf5_hl_fortran-static)
...
set_target_properties(hdf5-static PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:m>;\$<LINK_ONLY:dl>;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi.so;\$<LINK_ONLY:ZLIB::ZLIB>;\$<\$<PLATFORM_ID:Windows>:>;\$<\$<NOT:\$<PLATFORM_ID:Windows>>:dl>;\$<\$<BOOL:ON>:MPI::MPI_C>;\$<LINK_ONLY:\$<\$<OR:\$<BOOL:OFF>,\$<BOOL:OFF>>:Threads::Threads>>"
)
...
set_target_properties(hdf5_fortran-static PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "hdf5_f90cstub-static;\$<LINK_ONLY:m>;\$<LINK_ONLY:dl>;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_usempif08.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_usempi_ignore_tkr.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_mpifh.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi.so;\$<LINK_ONLY:\$<\$<BOOL:ON>:/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_usempif08.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_usempi_ignore_tkr.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi_mpifh.so;/opt/openmpi/bin/5.0.7/gnu/14.2.0/lib/libmpi.so>>"
)
